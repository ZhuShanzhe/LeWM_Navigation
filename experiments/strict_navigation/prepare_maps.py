...
R=Path('/root/autodl-tmp/lewm_research/strict_nav_20260910');D=R/'maps'
torch.set_num_threads(1)
specs=[]
for split,centers in [('train',[49,81,113,145]),('validation',[65,129]),('test',[97,161,177])]:
 for axis in [1,0]:
...
rng=np.random.default_rng(9102030)
...
for spec in specs:
 env=gym.make('swm/TwoRoom-v1',init_value=spec['init_value']).unwrapped;env.reset(seed=9102030)
 ...
 body={**spec,'selection_seed':9102030,'task':'synthetic direct-goal navigation; key 75 is adapter compatibility, not logged horizon','distance_range':[75,125],'cases':rows}
