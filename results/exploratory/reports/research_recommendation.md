...
本轮队列已完成，耗时约 8.11 小时（包括准备与下载），早于 12 小时上限。共 126 次正式评估，其中 75 次为固定 150 条轨迹上的配对评估（25 种组合×3 批次），并非 3,750 个独立测试场景。两个从零训练种子均完成 10 epochs、58,410 步。另有三个 3,000 步早期消融，不称为完整收敛实验。自动病例/轨迹检查无异常，GPU 实验进程已退出；服务器没有自动关机。
...
|---|---:|---:|---:|
| 短目标，预算50 | 80.7% | 95.3% | 92.7% |
| 短目标，预算150 | 81.3% | 96.0% | 92.7% |
| 长目标，预算150 | 36.0% | 56.7% | 60.7% |
| 长目标，CEM迭代30 | 37.3% | 58.7% | 62.0% |
| 长目标，预测跨度10/候选150 | 41.3% | 63.3% | 65.3% |
| 长目标，每5环境步重规划/迭代2 | 35.3% | 55.3% | 64.7% |
| 长目标，每5环境步重规划/迭代10 | 36.0% | 62.7% | 68.7% |
...
- trained3072：位置探针R²=0.9966；开环MSE从1步的0.00491增至15步的0.15333，15步处每步真值纠正MSE为0.01000。
- trained3073：位置探针R²=0.9981；开环MSE从1步的0.00516增至15步的0.17407，15步处每步真值纠正MSE为0.00830。
...
|---|---:|---|---:|
| public | +0.0 | [-6.7, 6.7] | 2.51× |
| trained3072 | +6.0 | [0.7, 11.3] | 2.72× |
| trained3073 | +8.0 | [2.0, 14.0] | 2.45× |
